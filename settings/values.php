...
$mainValues = [
    'banned' => '❌ | اکانت شما مسدود شده ، لطفا با پشتیبانی تماس بگیرید 😑😂',
    ...
    'customer_custome_plan_name'=>'اسم کانفیگ رو وارد کنید ( حروف انگیلیسی و عدد باهم وارد کنید )',
    'send_user_id'=>"🀄️| آیدی عددی کاربر رو بفرستید :",
    ...
    'increase_wallet_cart_to_cart'=>"♻️ لطفا تصویر فیش واریزی را ارسال کنید :
...
",
    ...
    'send_only_number'=> "⚠️ | فقط عدد وارد کن",
    ...
    'start_message'=>'📡‏ ::: PumaNet ::: 📡
بدون هیچ محدودیت و تحریمی به دنیای اینترنت وصل شوید

✅ کیفیت اتصال
📝 ارتباط امن و مطمئن
☎️ پشتیبانی تا روز آخر 

به مدت محدود مبلغ 100 هزار تومان هدیه بگیرید
(پس از عضویت تا 24 ساعت، مبلغ هدیه به حسابتان اضافه خواهد شد)
