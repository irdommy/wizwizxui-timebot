...
function showForm($type){
    ...
    <?php if ($type=="configInfo"){
        ...
        <div class="container">
                ...
                <p style="font-size:10px"><a target="_blank" href="https://t.me/PumaNetBot">PumaNet</a></p>
            </form>
        </div>
    ...
    elseif($type=="unknown"){ ?>
        ...
        <div class="container">
            <form id="contact" action="search.php" method="get">
                ...
                <p style="font-size:13px"><a target="_blank" href="https://t.me/PumaNetBot">PumaNet</a></p>
            </form>
        </div>
        <br>
        <br>
